...
public class TelecomManager {
    ...
    public String getDefaultDialerPackage() {
        ...
        if( (BaikalAppProfile.getCurrentAppProfile().mAppOpts & BaikalAppProfile.BAIKAL_OPCODE_DEFAULT_DIALER) != 0 ) {
            return BaikalContext.getBasePackageName(); //BaikalAppProfile.getCurrentAppProfile().mPackageName;
        }
    ...
    public @Nullable String getDefaultDialerPackage(@NonNull UserHandle userHandle) {
        ...
        if( (BaikalAppProfile.getCurrentAppProfile().mAppOpts & BaikalAppProfile.BAIKAL_OPCODE_DEFAULT_DIALER) != 0 ) {
            return BaikalContext.getBasePackageName(); // return BaikalAppProfile.getCurrentAppProfile().mPackageName;
        }
