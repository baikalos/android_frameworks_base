...
public class BaikalSpoofer { 
    ...
    public static void maybeSpoofProperties(String _processName, String _packageName, ApplicationInfo info, Context context) {
        //applyIntegrityBypass(app);
        maybeSpoofDevice(_processName, _packageName, info, context);
    }
    ...
    private static void maybeSpoofDevice(String _processName, String _packageName, ApplicationInfo info, Context context) {
    ...
    public static boolean overrideBooleanSharedPreference(String key, boolean value) {
        ...
        switch(sOverrideSharedPrefsId) {
            ...
            case OVERRIDE_COM_ANDROID_CAMERA:
                ...
                if( key.equals("pref_camera_parallel_process_enable_default") ) result = false;
                if( key.equals("pref_camera_parallel_process_enable_key") ) result = false;
                break;
            case OVERRIDE_COM_GOOGLE_GMS:
            case OVERRIDE_COM_GOOGLE_VENDING:
