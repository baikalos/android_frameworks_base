...
public class BaikalSpoofer { 
    ...
    public static BaikalAppProfile sCurrentBaikalAppProfile = new BaikalAppProfile("<temporary>",-2);
    ...
    private static boolean isProfileDebug() {
    ...
    private static void maybeSpoofDevice(Application app, Context context) {
        ...
        if( myUid() == 1000 ) {
            ...
            try {
                ...
                profile = context.getBaikalContext().getBaikalAppProfileNotNull(packageName, myUid());
                sCurrentBaikalAppProfile = profile;
    ...
    public static void onEngineGetCertificateChain() {
        ...
        if(sPreventHwKeyAttestation) {
            Log.i(TAG, "HW Attestation disabled for " + sPackageName +  "/" + myUid());
