...
public class BaikalActions { 
    ...
    public static final String ACTION_CHARGING_MODE_CHANGED = "com.android.internal.baikalos.Actions.ACTION_CHARGING_MODE_CHANGED";
    ...
    public static void sendChargingModeChanged(int mode) {
        Intent intent = new Intent(ACTION_CHARGING_MODE_CHANGED);
        intent.addFlags(Intent.FLAG_RECEIVER_REGISTERED_ONLY);
    	intent.putExtra(EXTRA_INT_MODE,mode);
    	enqueueIntent(intent);
    }
