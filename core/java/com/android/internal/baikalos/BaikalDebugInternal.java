...
public class BaikalDebugInternal extends ContentObserver { 
    ...
    private BaikalDebugInternal(Handler handler, Context context) {
        ...
        try {
            ...
            Slog.i(TAG,"can't register observer. ", e);
        }
    }
    ...
    public void updateConstantsLocked() {
        ...
        try {
            ...
            boolean debug = mContext.getBaikalContext().getBaikalService().getBaikalSettingInt(0,
                        Settings.Global.BAIKALOS_DEBUG,0) != 0;


            String debugMaskString = mContext.getBaikalContext().getBaikalService().getBaikalSettingString(0,
                        Settings.Global.BAIKALOS_DEBUG_MASK, "");
            ...
            Slog.e(TAG,"BaikalDebugInternal:",e);
        }
    }
