...
public final class AttestationHooks {
    ...
    private static byte[] modifyLeaf(byte[] bytes) throws Throwable {
        ...
        if (DEBUG) Log.e(TAG, "onGetKeyEntry: Return modified certificate leaf" );
    ...
    public static KeyEntryResponse onGetKeyEntry(KeyEntryResponse response) {
        ...
        if (BaikalSpoofer.sDisableCertificateSpoof)
            return response;

        if (response.metadata == null || response.metadata.certificate == null)
            return response;
