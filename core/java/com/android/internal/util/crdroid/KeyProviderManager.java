...
public final class KeyProviderManager {
    ...
    private static boolean mForceLegacyKeymaster;
    private static int mKeymasterVersion = -1;
    ...
    public static boolean getForceLegacyKeymaster() {
        return mForceLegacyKeymaster;
    }

    public static int getKeymasterVersion() {
        return mKeymasterVersion != -1 ? mKeymasterVersion : 100;
    }

    public static int getAttestationVersion() {
        return mAttestationVersion != -1 ? mAttestationVersion : 100;
    }
    ...
    private static class DefaultKeyboxProvider implements IKeyboxProvider {
        ...
        private DefaultKeyboxProvider() {
            ...
            mForceLegacyKeymaster = SystemProperties.getBoolean("persist.baikal.legacykm", SystemProperties.getBoolean("ro.baikal.legacykm",false));
            Log.d(TAG, "mForceLegacyKeymaster:" + mForceLegacyKeymaster);

            if( mForceLegacyKeymaster ) {
                int keymasterVersion = SystemProperties.getInt("persist.baikal.legacykm.ver", SystemProperties.getInt("ro.baikal.legacykm.ver",-1));
                switch(keymasterVersion) {
                    case 20:
                        mAttestationVersion = 2;
                        mKeymasterVersion = 20;
                        break;
                    case 30:
                        mAttestationVersion = 3;
                        mKeymasterVersion = 30;
                        break;
                    case 40:
                        mAttestationVersion = 4;
                        mKeymasterVersion = 40;
                        break;
                    case 41:
                        mAttestationVersion = 4;
                        mKeymasterVersion = 41;
                        break;
                    default:
                        Log.d(TAG, "Invalid keymaster version:" + keymasterVersion);

                }
                Log.d(TAG, "mKeymasterVersion:" + mKeymasterVersion + "/" + mAttestationVersion);
            }
                        ...
                        switch (tag) {
                            ...
                            case "Key":
                                ...
                                if ("ecdsa".equalsIgnoreCase(currentAlg)) currentAlg = "EC";
                                    ...
                                    Log.w(TAG, "Unknown algo:" + currentAlg);
                                    currentAlg = null;
