...
public final class Settings {
    ...
    private static class NameValueCache {
        ...
        public String getStringForUser(ContentResolver cr, String name,
            ...
            if( BaikalSpoofer.isHideDevMode() ){
                if( Secure.ALLOW_MOCK_LOCATION.equals(name) || 
                    ...
                    Log.d(TAG, "getStringForUser." + name + ": hidden for " + cr.getPackageName() + "/" + Process.myUid() + "/" + Process.myPid());
                    return "0";
                }
            }
            ...
            if( BaikalConstants.BAIKAL_DEBUG_APP_PROFILE ) {
                if( Secure.ALLOW_MOCK_LOCATION.equals(name) || 
                    ...
                    Settings.Global.ADB_ENABLED.equals(name) || 
                    Settings.Global.ADB_WIFI_ENABLED.equals(name) ) {
                    Log.d(TAG, "getStringForUser." + name + ": for " + cr.getPackageName() + "/" + Process.myUid() + "/" + Process.myPid());
                }
            }

            if( BaikalSpoofer.isProfileDebug()) {
                Log.d(TAG, "getStringForUser." + name + ": for " + cr.getPackageName() + "/" + Process.myUid() + "/" + Process.myPid());
            }
                ...
                if( names != null ) {
                    if (!names.isEmpty()) {
                        for (String name : names) {
                            Log.d(TAG, "getStringsForPrefixStripPrefix." + name + ": for " + cr.getPackageName() + "/" + Process.myUid() + "/" + Process.myPid());
                        }
                    }
                }
            }
    ...
    public static final class Secure extends NameValueTable {
       ...
       /**
         ...
         * @hide
         */
        public static final String SPOOF_TRICKYSTORE_AUTO_KEYBOX = "spoof_trickystore_auto_keybox";
    ...
    public static final class Global extends NameValueTable {
        ...
        */
        ...
        /**
         * BaikalOS Global Settings Start
         */        
         ...
         * @hide
         */
        public static final String BAIKALOS_BPCHARGE_TOP_APP = "baikalos_bpcharge_top_app";
