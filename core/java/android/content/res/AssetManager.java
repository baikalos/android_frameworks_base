...
public final class AssetManager implements AutoCloseable {
    ...
    private static final String BAIKALOS_APK_PATH = "/system/framework/org.lineageos.platform-res.apk";
    ...
    public static void createSystemAssetsInZygoteLocked(boolean reinitialize,
        ...
        try {
            ...
            apkAssets.add(ApkAssets.loadFromPath(BAIKALOS_APK_PATH, ApkAssets.PROPERTY_SYSTEM));
