...
interface IBaikalService {
    ...
    @RequiresNoPermission
    BaikalAppProfile getBaikalAppProfile(int uid);
    @RequiresNoPermission
    BaikalAppProfile getBaikalAppProfileNotNull(int uid);
    @RequiresNoPermission
    BaikalAppProfile getBaikalAppProfileByPackageName(String packageName);
    @RequiresNoPermission
    ...
    @RequiresNoPermission
    String getBaikalPowerModeName(int mode);
    @RequiresNoPermission
    ...
    @RequiresNoPermission
    float getAppVolume(String packageName);
}
