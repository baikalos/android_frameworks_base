...
public class BaikalDevices extends ContentObserver {
    ...
    private static final String TAG = "BaikalDevices";
    ...
    private com.android.server.trust.BaikalTrust mBaikalTrust;
    private BaikalSpecialDevices mBaikalSpecialDevices;

    public void setBaikalTrust(com.android.server.trust.BaikalTrust baikalTrust) {
