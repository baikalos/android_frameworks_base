...
public class BaikalSpecialDevices extends ContentObserver {
    ...
    private static final String TAG = "BaikalSpecialDevices";
    ...
    static BaikalSpecialDevices sInstance;
    ...
    public static BaikalSpecialDevices getInstance() {
        return sInstance;
    }

    public static BaikalSpecialDevices getInstance(Handler handler, Context context) {
        if( sInstance == null ) {
            synchronized(sInstanceLock) {
                if( sInstance == null ) {
                    sInstance = new BaikalSpecialDevices(handler, context);
                }
            }
        }
        return sInstance;
    ...
    private BaikalSpecialDevices(Handler handler, Context context) {
        super(handler);
