...
public interface IBaikalInternal {
     ...
     *
     */
    @Nullable BaikalAppProfile getBaikalAppProfile(int uid);
    //@Nullable BaikalAppProfile getBaikalAppProfile(@Nullable String packageName, int uid);

    /**
     *
     */
    BaikalAppProfile getBaikalAppProfileNotNull(int uid);
    //BaikalAppProfile getBaikalAppProfileNotNull(@Nullable String packageName, int uid);

    /**
     *
     */
    @Nullable BaikalAppProfile getBaikalAppProfileByPackageName(@Nullable String packageName);

    /**
     *
     */
    BaikalAppProfile getUserProfile(int uid);

    /**
     *
     */
    BaikalAppProfile getUserProfile(@Nullable String packageName);
    ...
    void incBackgroundStartCount(int uid);
    int getBackgroundStartCount(int uid);
}
