...
public final class BaikalService extends com.android.server.SystemService {
    ...
    private IBaikalInternal getLocalService() {
        return new IBaikalInternal() {
            ...
            public BaikalAppProfile getBaikalAppProfile(String packageName, int uid) {
                return getBaikalAppProfileInternal(packageName, uid);
            }
             ...
             */
            @Override
            public BaikalAppProfile getBaikalAppProfileNotNull(String packageName, int uid) {
                return getBaikalAppProfileNotNullInternal(packageName, uid);
            }
    ...
    public BaikalAppProfile getBaikalAppProfileInternal(String packageName, int uid) {
        return mBaikalAppProfileService.getProfileInternal(uid);
    }

    public BaikalAppProfile getBaikalAppProfileNotNullInternal(String packageName, int uid) {
