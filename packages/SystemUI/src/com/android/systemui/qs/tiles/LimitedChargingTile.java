...
public class LimitedChargingTile extends QSTileImpl<BooleanState> {

    public static final String TILE_SPEC = "ltcharge";
    ...
    public CharSequence getTileLabel() {
        return "Limited Charging"; //mContext.getString(R.string.quick_settings_stamina_label);
    }
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        state.icon = mIcon;
        if( mBPCEnabled )
            state.label = "Limited Charging Enabled";  //mContext.getString(R.string.quick_settings_stamina_label);
        else
            state.label = "Limited Charging Disabled";  //mContext.getString(R.string.quick_settings_stamina_label);
